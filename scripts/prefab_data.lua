...
--     -- prefab_create(Folders.Morvex,    "finn.xml",         "finn",           {Tags.tv_shows}),
--     -- prefab_create(Folders.Morvex,    "lara croft.xml",   "lara croft",     {Tags.games}),
...
--     -- prefab_create(Folders.SnakeyWakey,    "GMan.xml",                    "GMan" ,                  {Tags.games}),
--     -- prefab_create(Folders.SnakeyWakey,    "Gus Fring.xml",               "Gus Fring",              {Tags.tv_shows}),
--     -- prefab_create(Folders.SnakeyWakey,    "Hank Schrader.xml",           "Hank Schrader",          {Tags.tv_shows}),
--     -- prefab_create(Folders.SnakeyWakey,    "Hazmat.xml",                  "Hazmat",                 {Tags.emt}),
--     -- prefab_create(Folders.SnakeyWakey,    "Hector Salamanca.xml",        "Hector Salamanca" ,      {Tags.tv_shows}),
--     -- prefab_create(Folders.SnakeyWakey,    "Heisenberg.xml",              "Heisenberg",             {Tags.tv_shows}),
...
--     -- prefab_create(Folders.SnakeyWakey,    "jesse Pinkman.xml",    "jesse Pinkman",      {Tags.tv_shows}),
...
--     -- prefab_create(Folders.SnakeyWakey,    "Mike Ehrmantraut.xml", "Mike Ehrmantraut",   {Tags.tv_shows}),
...
--     -- prefab_create(Folders.SnakeyWakey,    "Saul Goodman.xml",     "Saul Goodman",       {Tags.tv_shows}),
...
--     -- prefab_create(Folders.SnakeyWakey,    "Walter White Bald.xml",   "Walter White Bald",     {Tags.tv_shows}),
--     -- prefab_create(Folders.SnakeyWakey,    "Walter White Cook.xml",   "Walter White Cook",     {Tags.tv_shows}),
--     -- prefab_create(Folders.SnakeyWakey,    "Walter White Hazmat.xml", "Walter White Hazmat",   {Tags.tv_shows}),
--     -- prefab_create(Folders.SnakeyWakey,    "Walter White.xml",        "Walter White",          {Tags.tv_shows}),
--     -- prefab_create(Folders.SnakeyWakey,    "Walter White2 Bald.xml",  "Walter White2 Bald",    {Tags.tv_shows}),
--     -- prefab_create(Folders.SnakeyWakey,    "Walter White2.xml",       "Walter White2",         {Tags.tv_shows}),
...
--     -- prefab_create(Folders.Squareblock,    "Stig.xml",               "Stig",             {Tags.tv_shows}),
